#This file plots the Global Active Power Histogram
...
#For the histogram, we only need to read in the Global_Active_power which is the third column.
colClasses = c("NULL","NULL",NA,"NULL","NULL","NULL","NULL","NULL","NULL")
#twoDayData = read.csv("two_day_consumption.csv", colClasses = colClasses)
